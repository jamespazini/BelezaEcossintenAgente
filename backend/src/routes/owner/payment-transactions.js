/**
 * Payment Transactions Routes Wrapper
 */

const { sequelize } = require('../../models');
const { authenticate, authorize } = require('../../middleware/auth');
const tenantFromJWT = require('../../middleware/tenantFromJWT');
const { initFinancialModule } = require('../../modules/financial');

// Get all models from sequelize
const models = sequelize.models;

// Initialize module with all models
const financialModule = initFinancialModule(sequelize, models);
...
const routes = financialModule.createRoutes(middleware);
